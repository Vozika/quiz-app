            ...
            >
              <Item>
                <div className="answer">
                  ...
                  <div className={props.showRightAnimation ? "animate__animated animate__bounce" : "animate__animated"}>
              ...
              <Item>
                <div className="answer">
                <div className={props.showWrongAnimation ? "animate__animated animate__bounce" : "animate__animated"}>
                  <ThumbDownIcon /></div>
